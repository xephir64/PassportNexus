...
public class LoginController : ControllerBase
{
    ...
    public async Task<IActionResult> Login()
    {
        ...
        if (Request.Headers.ContainsKey("Authorization"))
        {
            ...
            PassportTicket ticket = _crypto.CreateTicket(user.Id, user.Email);
            Response.Headers["Authentication-Info"] = $"Passport1.4 da-status=success,from-PP='{ticket.Ticket}',ru=http://messenger.msn.com";
